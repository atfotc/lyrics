            ...
            <div class="col-md-8">
                <form method="post" action="{{ route('songs.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" aria-describedby="name-help" placeholder="Enter song name" value="{{ old('name') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="creators" name="creators" aria-describedby="creators-help" placeholder="Enter the names of the song creators" value="{{ old('creators') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="performers" name="performers" aria-describedby="performers-help" placeholder="Enter the names of the song performers" value="{{ old('performers') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="year" name="year" aria-describedby="year-help" placeholder="Enter the year the song was performed" value="{{ old('year') }}">
